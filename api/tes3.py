...
# Initialize cache for storing book content
content_cache = TTLCache(maxsize=100, ttl=3600)  # Cache size 100, TTL 1 hour
...
# Cache the text extraction process to avoid re-reading the same file
